# Онлайн проект <a href="https://github.com/JavaWebinar/topjava10">Topjava</a>
...
- Сделал Constructor injection. Выигрыш: final поля, независимость от контейнера
...
Предусловия подробно будут на 4-м уроке. Мы падаем сразу на входе и понятно где по стактрайсу. А не "может быть потом" и разбирайся откуда. <a href="http://stackoverflow.com/questions/27511106/what-is-the-purpose-of-objectsrequirenonnull#27511204">What is the purpose of Objects#requireNonNull</a>. 
