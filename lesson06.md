...
#### Apply 5-HW5-update-hsqldb.patch
...
#### Apply 6-HW5-optional-fetch-join.patch
...
#### Apply 7-HW5-graph-batch-size.patch
...
> - <a href="http://hibernate.org/validator/documentation/getting-started/#unified-expression-language-el">EL implementation provided by the container. In a Java SE you have to add an implementation as dependency to your POM file</a>: добавил `javax.el` зависимости со `scope=provided`
...
#### Apply 9-add-test-validation.patch
...
#### Apply 10-hibernate-cache.patch
...
Запуск из коммандной строки:
     ...
     mvn clean package -DskipTests=true org.codehaus.cargo:cargo-maven2-plugin:1.6.3:run
